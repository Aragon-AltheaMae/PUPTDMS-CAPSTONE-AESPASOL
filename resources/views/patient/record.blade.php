            ...
            <section id="visitHistorySection" class="card records-visits-card">
                <div class="card-body">
                    ...
                    <x-pagination-bar id="recordsPagebarTop" info-id="recordsPageInfoTop"
                        ...
                        page-size-id="recordsPageSize" page-size-callback="changeRecordsPageSize"
                        :page-size-value="$records->perPage()" page-size-label="per page" label="visits"
            ...
            <section id="documentRequestHistory" class="card document-history-card">
                ...
                <div class="card-body">
                    ...
                    <x-pagination-bar id="documentRequestsPagebarTop" info-id="documentRequestsPageInfoTop"
                        ...
                        :page-size-value="$documentRequests->perPage()" page-size-label="per page" label="requests"
                        :total="$documentRequests->total()" :from="$documentRequests->firstItem() ?? 0"
                        :to="$documentRequests->lastItem() ?? 0" />
                    ...
                    <div id="documentRequestsList" class="document-history-list">
                        ...
                        <article class="global-record-card document-request-item" style="
                            --record-accent:
                            ...
                            <div class="global-record-card-grid">
                                ...
                                <div>
                                    <h3 class="global-record-name">
                                        {{ \Illuminate\Support\Str::of($documentRequest->document_type ??
                                        'Document')->replace(['_', '-'], ' ')->title() }}
                                    </h3>
