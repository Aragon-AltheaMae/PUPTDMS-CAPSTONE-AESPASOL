...
<main id="mainContent"
    ...
    <div class="w-full">
        ...
        <div class="mb-4">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Information, policies, and the development team
                behind PUPTDMS.</p>
        </div>
        ...
        <div class="about-top-grid">
            ...
            <div class="about-card fade-up delay-1">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-6 relative z-10">To ensure smooth operations and
                    accommodate as many patients as possible, please observe the following clinic rules:</p>
                ...
                <ul class="guideline-list">
                    <li>
                        ...
                        <div class="guide-text">
                            ...
                            <p>Walk-ins are currently discouraged unless it is a dental emergency. Please book your
                                slots via this portal.</p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="guide-text">
                            ...
                            <p>Arrive at the clinic at least 10-15 minutes before your scheduled appointment time.
                                Latecomers may have their slots forfeited.</p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="guide-text">
                            ...
                            <p>Patients cannot cancel appointments directly through the system. If you cannot make it to
                                your schedule, please notify the clinic directly so your slot can be given to others.
                            </p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="guide-text">
                            <h4>Eligibility</h4>
                            <p>Free dental services are strictly for the PUP Taguig community. Please bring a valid PUP
                                ID or registration card on your visit.</p>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="about-card fade-up delay-3 mb-6">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 relative z-10 max-w-4xl">
                The <strong>PUP Taguig Dental Management System (PUPTDMS)</strong> is a capstone project developed to
                digitize records, streamline appointment scheduling, and improve the overall efficiency of the campus
                dental clinic.
            </p>
