...
@section('content')
    ...
    <x-booking.confirmed-modal id="confirmModal" eyebrow="Appointment Booking" title="Appointment Confirmed"
        subtitle="Your appointment has been successfully scheduled." header-icon="fa-check"
        section-icon="fa-calendar-check" section-eyebrow="Booking Status" section-title="Booking successfully completed"
        section-message="Your selected appointment schedule has been saved and confirmed."
        detail-label="Appointment Status" result-title="Confirmed" message-title="Schedule details"
