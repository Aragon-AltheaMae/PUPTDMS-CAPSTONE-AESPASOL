    ...
    <main id="mainContent" class="booking-page page-enter">
        <div class="booking-page-inner">
            ...
            "
                            ...
                            <x-booking.service-step :services="$serviceTypes" :selected="old('service_type', $defaults['service_type'] ?? '')" title="Choose Dental Service"
                                subtitle="Select the dental service performed during this appointment." />

                            <x-booking.dental-history :questions="$dentalQuestions" mode="nested" :answers="$dentalAnswers" :defaults="$defaults"
                            ...
                            <div class="step-content hidden">
                                <div class="booking-step-shell">
                                    ...
                                    <div class="booking-step-body">
                                        ...
                                        <x-booking.medical-history-fields :questions="$medicalQuestions" :diseases="$diseases" mode="nested"
                                            :answers="$medicalAnswers" :defaults="$defaults" :selected-diseases="$selectedDiseases" :is-female="$isFemalePatient" />
