...
<head>
  ...
  <title>PUPT-DMS | Dentist Portal</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .login-card {
      ...
      box-shadow: 0 40px 100px rgba(0,0,0,.6), 0 0 0 1px rgba(13,115,119,.1);
    ...
    .form-sub { font-size: 13px; color: rgba(255,255,255,.38); margin-bottom: 30px; }
    ...
    .pw-toggle {
      ...
      color: rgba(255,255,255,.3); transition: color .2s; padding: 4px;
    }
    .pw-toggle:hover { color: var(--teal); }

    /* autofill dark override */
    input:-webkit-autofill, input:-webkit-autofill:focus {
      -webkit-box-shadow: 0 0 0 40px #0f1e35 inset !important;
    ...
    .btn-submit {
      ...
      background: linear-gradient(135deg, var(--teal) 0%, #14A5AA 100%);
    ...
    .btn-submit:hover {
      ...
      box-shadow: 0 8px 28px rgba(13,115,119,.55);
    }
    ...
    .logo-row img { width: 32px; height: 32px; object-fit: contain; opacity: .85; }
...
<body>
  ...
  <div class="login-card">
    ...
    <h1 class="form-title">Dentist Sign In</h1>
    <p class="form-sub">PUP Taguig Dental Clinic — Staff Access</p>
    ...
    <form method="POST" action="{{ route('dentist.login.submit') }}">
      ...
      <div class="field-group">
        ...
        <div class="pw-wrap">
          <input type="password" id="dentistPw" name="password" required placeholder="••••••••" class="field-input" style="padding-right:42px;">
          <button type="button" class="pw-toggle" onclick="togglePw('dentistPw','dentistEye')">
            <svg id="dentistEye" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
