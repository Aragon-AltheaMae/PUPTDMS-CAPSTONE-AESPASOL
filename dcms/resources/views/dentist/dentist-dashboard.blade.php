            ...
            <div class="row2-grid">
                <div>
                    <div id="dentistCalendarContainer"
                        class="bg-white shadow-sm rounded-2xl p-6 w-full min-h-[420px] h-full">
                ...
                <div class="relative bg-white p-5 rounded-3xl shadow-sm flex flex-col shadow-xl">
                    ...
                    <div class="flex-grow flex items-center justify-center w-full min-h-[200px]">
                        ...
                        <div id="empty-state-container"
                            class="flex flex-col items-center justify-center text-gray-500 gap-4" style="display: none;">
                            ...
                            <div class="relative z-10 overflow-y-auto overflow-x-auto pr-1" style="max-height: 180px;">
                                <table class="w-full text-left border-collapse">
                                    <thead class="sticky top-0 bg-white/90 backdrop-blur-sm z-10">
                                        <tr
                                            class="text-[10px] uppercase tracking-widest text-gray-400 border-b border-gray-100">
                                        ...
                                        @foreach ($medicalSupplies as $item)
                                            @php
                                                ...
                                                <td class="py-2.5 text-right">
                                                    <span
                                                        class="px-2 py-1 rounded-md border text-[10px] font-bold {{ $badgeCls }}">
                                                        {{ $balance }}{{ $isLow ? ' ⚠' : '' }}
                                                    </span>
                                                </td>
                                            </tr>
