...
<body class="bg-gray-200 min-h-screen flex flex-col">
  ...
  <header class="bg-gradient-to-r from-[#660000] to-[#8B0000] text-white px-8 py-4 flex justify-between items-center">
    ...
    <div class="flex items-center gap-8">
      ...
      <div class="dropdown dropdown-end">
        ...
        <div tabindex="0"
          class="dropdown-content z-[50] mt-3 w-80 rounded-2xl bg-white shadow-xl border border-gray-100">
          <div class="p-4 border-b flex items-center justify-between">
            <span class="font-bold text-[#8B0000]">Notifications</span>

            {{-- Optional "View all" (only if you have this route) --}}
            {{-- <a href="{{ route('notifications.index') }}" class="text-xs text-[#8B0000] hover:underline">View
              all</a> --}}
          </div>
  ...
  <header class="bg-primaryMain text-white px-8 py-3">
    <nav class="flex justify-end items-center">
      ...
      <a href="{{ route('dentist.dentist.report') }}" class="bg-white text-[#8B0000] px-5 py-2 rounded-lg text-sm font-semibold
  ...
  <main class="p-8 min-h-[calc(100vh-200px)]">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <button onclick="createReportModal.showModal()" type="button" class="flex items-center gap-4 px-6 py-3 rounded-xl
        ...
        <div class="flex items-center gap-6">
          ...
          <div class="flex items-center bg-gradient-to-r from-[#8B0000] to-[#F2C94C] p-[2px] rounded-full">
            <div id="filterWrapper" class="flex items-center bg-white rounded-full overflow-hidden transition">
              ...
              <div id="filterPill" class="flex items-center transition">
      ...
      <form class="space-y-6" id="reportForm">
        ...
        <div class="grid grid-cols-4 items-center gap-4">
          ...
          <div class="col-span-3 flex gap-4">
            <input type="month" id="fromMonth" class="input input-bordered w-full" placeholder="From (Month & Year)" />
            <input type="month" id="toMonth" class="input input-bordered w-full" placeholder="To (Month & Year)" />
          </div>
        </div>
