...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400&family=DM+Serif+Display&display=swap"
    rel="stylesheet">
  ...
  <main id="mainContent" class="pt-[62px] min-h-screen pb-10" style="margin-left:220px;">
    <div class="max-w-7xl mx-auto px-6 py-8 fade-up">
      ...
      <div style="margin-bottom:1.75rem;">
        ...
        <p style="color:#999; font-size:.83rem; margin:.3rem 0 0;">Review, approve or reject patient document requests
        </p>
      </div>
    ...
    <div class="modal-box-inner" style="max-width:480px;">
      <div class="modal-hd" style="background:linear-gradient(135deg,#6b0000,#8B0000); border-bottom:none;">
        <div>
          ...
          <div style="font-size:.74rem; color:rgba(255,255,255,.65); margin-top:.18rem;">Narrow down the list by
            applying filters below</div>
        </div>
        ...
        <div class="reject-patient-card">
          ...
          <div>
            <div
              ...
              Patient</div>
            <div id="rejectPatientName" style="font-size:1.05rem; font-weight:800; color:#7f1d1d; line-height:1.2;">—
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    function applyTheme(theme) {
      ...
      document.querySelectorAll(".theme-option").forEach(o =>
        o.getAttribute("data-theme") === theme
