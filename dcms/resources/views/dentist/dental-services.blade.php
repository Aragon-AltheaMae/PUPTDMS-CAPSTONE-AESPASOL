  ...
  <div class="flex justify-between items-center mb-6">
    ...
    <div>
      ...
      <div class="mt-2 flex items-center gap-3">
        ...
        <input type="month" id="monthPicker" class="border border-gray-300 rounded-md
    ...
    <button onclick="createReportModal.showModal()" class="flex items-center gap-4 px-6 py-3 rounded-xl
  ...
  <div class="bg-white w-[760px] rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
    ...
    <div class="px-6 py-5 space-y-5 max-h-[76vh] overflow-y-auto scroll-smooth">
      ...
      <div class="grid grid-cols-3 gap-5 text-sm">
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="checkbox" name="gender" value="Male"
            class="checkbox-red gadGender"> Male</label>
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="checkbox" name="gender" value="Female"
            class="checkbox-red gadGender"> Female</label>
      </div>
      ...
      <div class="grid grid-cols-3 gap-5 text-sm">
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="checkbox" name="gad" value="PWD"
            class="checkbox-red gadPriority"> PWD</label>
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="checkbox" name="gad" value="Senior"
            class="checkbox-red gadPriority"> Senior</label>
      </div>
      ...
      <div class="grid grid-cols-3 gap-5 text-sm">
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="type" value="Emergency"
            class="radio-red"> Emergency</label>
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="type"
            value="Non-Emergency" class="radio-red"> Non-Emergency</label>
      </div>
      ...
      <div class="grid grid-cols-3 gap-5 text-sm">
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="department"
            value="Administrative" class="radio-red departmentRadio"> Administrative</label>
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="department"
            value="Faculty" class="radio-red departmentRadio"> Faculty</label>
        <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="department"
            value="Dependent" class="radio-red departmentRadio"> Dependent</label>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="grid grid-cols-6 gap-x-8 gap-y-4 text-sm">
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSIT"> BSIT</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSECE"> BSECE</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSBA - HRM"> BSBA - HRM</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSED - ENG"> BSED - ENG</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSOA"> BSOA</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSPSYCH"> BSPSYCH</label>

          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="DIT"> DIT</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSME"> BSME</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSBA - MM"> BSBA - MM</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="BSED - MATH"> BSED - MATH</label>
          <label class="flex items-center gap-3 text-sm text-gray-700"><input type="radio" name="course"
              class="radio-red programRadio" value="DOMT"> DOMT</label>
        </div>
      </div>
      ...
      <div class="grid grid-cols-12 gap-10">
        ...
        <div class="col-span-6 space-y-3">
          ...
          <div class="grid grid-cols-2 gap-y-3 text-sm text-gray-700">
            <label class="flex items-center gap-3"><input type="radio" name="year" value="1"
                class="filter-input radio-red studentyearRadio" /> 1st Year</label>
            <label class="flex items-center gap-3"><input type="radio" name="year" value="3"
                class="filter-input radio-red studentyearRadio" /> 3rd Year</label>
            <label class="flex items-center gap-3"><input type="radio" name="year" value="2"
                class="filter-input radio-red studentyearRadio" /> 2nd Year</label>
            <label class="flex items-center gap-3"><input type="radio" name="year" value="4"
                class="filter-input radio-red studentyearRadio" /> 4th Year</label>
          </div>
        </div>
        ...
        <div class="col-span-6 space-y-3">
          ...
          <div class="space-y-3 text-sm text-gray-700">
            <label class="flex items-center gap-3"><input type="radio" name="section" value="1"
                class="filter-input radio-red sectionRadio" /> 1</label>
            <label class="flex items-center gap-3"><input type="radio" name="section" value="2"
                class="filter-input radio-red sectionRadio" /> 2</label>
          </div>
        </div>
      </div>
  ...
  <div class="modal-box max-w-4xl border-2 border-blue-400 bg-white">
    ...
    <form class="space-y-6" id="reportForm">
      ...
      <div class="grid grid-cols-4 items-center gap-4">
        ...
        <select class="col-span-3 select select-bordered w-full border-yellow-400 bg-white focus:outline-none">
      ...
      <div class="grid grid-cols-4 items-center gap-4">
        ...
        <div class="col-span-3 flex gap-4">
          <input type="date" class="input input-bordered border-yellow-400 bg-white w-full" />
          <input type="date" class="input input-bordered border-yellow-400 bg-white w-full" />
        </div>
      </div>
      ...
      <div class="grid grid-cols-4 items-center gap-4">
        ...
        <input type="number" value="0" class="col-span-1 input input-bordered border-yellow-400 bg-white w-full" />
      </div>

      <!-- ACTION BUTTONS -->
      <div class="flex justify-end gap-4 pt-6">
        <button type="button" id="downloadReportBtn" class="btn bg-[#8B0000] text-white px-8">
          Download Report
        </button>

        <button type="button" onclick="createReportModal.close()" class="btn bg-gray-700 text-white px-8">
          Back
        </button>
      </div>
    ...
    <div id="downloadCompleteTab"
      class="hidden fixed top-0 left-1/2 transform -translate-x-1/2 mt-4 bg-green-600 text-white py-2 px-8 rounded-lg shadow-lg">
      Download Complete
    </div>
