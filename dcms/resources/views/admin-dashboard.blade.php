...
<aside id="sidebar"
  ...
  <div id="sidebarNav" class="flex-1 px-3 text-gray-600 text-sm">
    <nav class="space-y-2 pb-4">
      ...
      <a href="{{ route('admin.system_logs') }}" class="sidebar-link group relative flex items-center pl-1 pr-3 py-2 rounded-xl transition-all duration-200 hover:bg-[#8B0000] hover:text-[#F4F4F4]">
        <span class="w-8 h-8 rounded-lg flex items-center justify-center">
      ...
      <a href="{{ route('admin.role_permissions') }}" class="sidebar-link group relative flex items-center pl-1 pr-3 py-2 rounded-xl transition-all duration-200 hover:bg-[#8B0000] hover:text-[#F4F4F4]">
        <span class="w-8 h-8 rounded-lg flex items-center justify-center">
