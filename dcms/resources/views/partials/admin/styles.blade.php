<style>
    ...
    .header-user-btn {
        ...
        align-items: center;
        gap: 8px;
        /* Spacing sa pagitan ng avatar at chevron/text */
        padding: 4px 12px 4px 4px;
        /* Maliit yung left padding para dikit ang avatar */
        background: rgba(255, 255, 255, 0.08);
        /* Semi-transparent background */
        border: 1px solid transparent;
        border-radius: 99px;
        /* Eto ang magbibigay ng perfect "pill" shape */
        cursor: pointer;
    ...
    .header-avatar {
        width: 36px; /* Nilakihan ng konti para mas fit sa pill */
        height: 36px;
        border-radius: 50%;
        border: 2px solid rgba(255, 255, 255, 0.2); /* Manipis na border sa avatar */
        object-fit: cover;
        display: block;
    }
