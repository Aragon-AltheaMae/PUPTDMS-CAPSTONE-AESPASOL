...
<head>
  ...
  <style>
    ...
    .nav-section-label {
      font-size: .65rem; font-weight:700; letter-spacing:.08em; color:#9CA3AF;
    ...
    #sidebar.collapsed .sidebar-link { justify-content:center; padding-left:10px; padding-right:0; }
...
<!-- ================= RECORD DETAILS MODAL (EXACT UI LOOK) ================= -->
<dialog id="record_modal" class="modal">
  <div class="modal-box 
              p-0
              w-full
              max-w-2xl        <!-- smaller width -->
              max-h-[90vh]     <!-- shorter height -->
              overflow-y-auto
              rounded-xl
              bg-[#F3F3F3]">
