...
<div class="bg-red-800 text-[#F4F4F4] px-6">
  ...
  <div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="bg-gradient-to-r from-[#8B0000] to-[#660000] text-[#F4F4F4] rounded-2xl p-10 flex justify-between items-center mb-20">
      ...
      <div class="w-1/5">
        <img src="dcms/public/images/home-tooth.png" alt="Tooth Icon" />
      </div>
    </div>
    ...
    <section class="max-w-7xl mx-auto px-2 mb-10">
      ...
      <!-- PROFILE CARD -->
      <div class="bg-gradient-to-t from-[#FFD700] to-[#660000] p-0.5 rounded-2xl md:w-1/3">
        <div class="bg-[#F4F4F4] rounded-2xl p-5 text-center">
          <div class="avatar mb-2 flex justify-center">
            <div class="w-[210px] rounded-full">
              <img src="dcms/public/images/hsh.jpg" alt="Profile Image" />
            </div>
          </div>
    ...
    <div class="bg-gradient-to-l from-[#FFD700] to-[#660000] p-0.5 rounded-2xl mb-10">
    ...
    <div class="bg-[#8B0000] w-24 p-4 flex items-center justify-center">
      <img src="dcms/public/images/dental-clearance.png"/>
    </div>
  ...
  <a href="#" class="flex border rounded-2xl overflow-hidden
          ...
          <div class="bg-[#8B0000] w-24 p-4 flex items-center justify-center">
            <img src="dcms/public/images/dental-health-record.png"/> </div>
...
<footer class="footer sm:footer-horizontal bg-[#660000] text-[#F4F4F4] p-10">
  ...
  function viewRecord(id) {
    window.location.href = `record-details.php?id=${id}`;
  }
