...
<body class="bg-[#F4F4F4] text-[#333333] font-normal min-h-screen flex flex-col">
  ...
  <main
    ...
    <!-- IMPORTANT: keep fade-in on content, but modals are OUTSIDE this container -->
            ...
            items-center text-[13px] text-[#8b0000]">
                ...
                <div class="flex flex-col gap-2 items-end pr-2">
                  ...
                  <button onclick="openCancelAppointmentModal()" class="h-6 w-[130px]
                    rounded-md text-[11px] font-semibold text-white bg-[#8b0000]
  ...
  <!-- ===================================================== -->
  <!-- MODALS MOVED HERE (OUTSIDE fade-in container) -->
  <!-- UI IS THE SAME - ONLY POSITIONING FIX -->
  <!-- ===================================================== -->

  <!-- ================= RESCHEDULE MODAL ================= -->
  <div id="rescheduleModal"
    class="fixed inset-0 bg-black/40 flex items-center justify-center hidden z-[9999]">
      ...
      <div class="px-10 py-7 bg-gray-50">
        ...
        <div class="flex justify-end gap-3">
          <button onclick="closeRescheduleModal()"
            class="px-6 py-2 rounded-lg border border-gray-300 bg-white text-gray-700 font-semibold
                   hover:bg-gray-100 transition text-sm shadow-sm">
            Cancel
          </button>
          <button onclick="confirmReschedule()"
            class="px-6 py-2 rounded-lg bg-yellow-400 text-gray-700 font-semibold hover:bg-yellow-500 transition text-sm shadow-sm">
            Reschedule
          </button>
        </div>
      </div>
  ...
  <div id="startProcedureModal"
    class="fixed inset-0 bg-black/50 flex items-center justify-center hidden z-[9999]">
    <div class="bg-white w-[560px] rounded-2xl overflow-hidden shadow-2xl">
